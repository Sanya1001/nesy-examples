...
from deepproblog.evaluate import get_confusion_matrix, get_fact_accuracy, fact_accuracy2
...
acc = get_fact_accuracy(model, test_set)
# get_fact_accuracy(model)
# print(acc)
